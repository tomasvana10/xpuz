...
def _run(*args, **kwargs):
    ...
    # Have to normalise the locales path because Flask cannot handle the PosixPath object for some reason
    app.config["BABEL_TRANSLATION_DIRECTORIES"] = os.path.normpath(Paths.LOCALES_PATH)
    babel = Babel(app)
